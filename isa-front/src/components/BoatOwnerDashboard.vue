  ...
  <div  style="border-radius: 20px; border-width: 1pt; border-color: #2c3e50; border-style: solid">
    <div class="horizontal">
      <div class="column" style="margin: 2%; width: 40%">
        ...
        <Bubble :chart-data="chartDataYearSelected"/>
      </div>
      <div class="column" style="margin: 2%; width: 40%">
...
export default {
  ...
  data: function (){
      return {
        ...
        chartDataYear: {
          ...
          datasets: [
            {
              label: 'Reservations for year all boats',
              backgroundColor: '#5350D5',
              data: []
            }
          ]
        ...
        chartDataMonth: {
          ...
          datasets: [
            {
              label: 'Reservations for current month all boats',
              backgroundColor: '#D56850',
              data: []
            }
          ]
        ...
        chartDataWeek: {
          ...
          datasets: [
            {
              label: 'Reservations for current week all boats',
              backgroundColor: '#48bf91',
              data: []
            }
          ]
  ...
  methods:{
    setFields(){
      ...
      this.weeklyIncomingsSelectedi = this.weeklySelected.incomings;
